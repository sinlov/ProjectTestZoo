...
/**
 * An activity representing a list of Presons. This activity has different
 ...
 */
public class PersonListActivity extends Activity implements
	...
	if (findViewById(R.id.person_detail_container) != null) {
	    ...
	    ((PersonListFragment) getFragmentManager().findFragmentById(
